...
MIT License - feel free to use for your college project or startup!
...
- [ ] Complete all frontend pages (Products, Orders, Customers, Settings)
...
- [ ] Custom domain for shops

---

**Made with ❤️ for small businesses in India**

🚀 **This is not just a college project - this can actually make you money!**
...
- ✅ REST API design
- ✅ Database modeling (7 collections)
- ✅ Authentication & Authorization
- ✅ Third-party API integrations (WhatsApp, AI, Payments)
